export default function SideModel({ children, toggle = false, setToggle }) {
    return (
        <div className={`${toggle ? 'block' : 'hidden'}`}>
            ...
            <div className={`absolute top-0 bottom-0 right-0 left-0 sm:left-auto bg-background border-l-1 border-border transition-all duration-150 ease-in-out z-40 shadow-md`}>
                {/* <div className=""> */}
                {children}
                {/* </div> */}
            </div>
